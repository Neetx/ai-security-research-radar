...
- 🕵️ **Capture-leak fix, [trend 009](TRENDS.md#id-ai-offensive-operations-009-in-the-wild-ai-for-offense-llms-weaponized-to-develop-malware-and-automate-offensive-operations-c2)**: Trend Micro's ["Vibe Hacking"](https://www.trendmicro.com/en_us/research/26/e/vibe-hacking-two-ai-augmented-campaigns-target-government-and-financial-sectors-in-latin-america.html) — two in-the-wild AI-agentic intrusion campaigns against LatAm government/financial targets, one exposed via the actor's own leaked C2 chat transcript — predates the Hugging Face/JADEPUFFER disclosures by 2+ months, named but never opened until now.
- 🔐 **[Trend 002](TRENDS.md#id-ai-vuln-discovery-002-llmagentic-vulnerability-discovery-repair--the-insecurity-of-ai-written-code) rotation**: [zkSecurity](https://blog.zksecurity.xyz/posts/openvm-bugs) found a critical, CVE-2026-46669-backed soundness bug in OpenVM's zkVM via a deployed dual-agent audit pipeline — and a fresh 3rd installment of the same series ([bron-crypto](https://blog.zksecurity.xyz/posts/bron-bugs/), 30 findings incl. one critical) is already [queued](TRENDS.md#observation_queue) for the next slot.
- 🛒 **New study pick**: [Protocol-Level Attacks on Agentic Commerce Platforms](https://arxiv.org/abs/2607.21824) — 33 structural, model-independent vulnerabilities (100% ASR) across three production agentic-commerce platforms, three chaining into an end-to-end payment hijack; queued as a fresh top rotate-candidate for trend 001.
- 📡 **Watchlist steady at 23**: one queue line promoted to evidence, one fresh 11-item batch queued from the weekend cs.CR backlog (agentic-commerce protocol attacks, production-Claude RAG-ranking manipulation, CTF-eval cheating, speculative-decoding DoS and more) — see the [queue](TRENDS.md#observation_queue).
...
|---|---|---|
| [In-the-wild AI-for-offense: LLM malware dev & C2](TRENDS.md#id-ai-offensive-operations-009-in-the-wild-ai-for-offense-llms-weaponized-to-develop-malware-and-automate-offensive-operations-c2) | 🚀 accelerating | [2026-07-21](https://openai.com/index/hugging-face-model-evaluation-security-incident) |
...
- No offensive-AI earthquake on the HN front page this pass — top items were general tech (cookie-banner tooling, a legal case, htmx on a Game Boy), nothing on-axis to queue.
...
- DEF CON AI Village announced [HalCTF: Hostile Autonomous Layer CTF at DEFCON 34](https://aivillage.org/blog/halctf/) — deploy an autonomous AI agent to exploit sandboxed challenge targets, a new AI-agent-offense CTF event, noted as context.

---

[TRENDS.md](TRENDS.md) · [watchlist (23)](TRENDS.md#observation_queue) · [reports/](reports/) · [latest daily: 2026-07-27](reports/2026-07-27.md) · [weekly: 2026-W30](reports/weekly/2026-W30.md) · [AGENTS.md](AGENTS.md) · [SOURCES.md](SOURCES.md)
