...
- 📡 **Watchlist 25→26** (−2 promoted into trend 007, −3 stale burndown, +6 incl. an [AI-vishing automation study](https://arxiv.org/abs/2607.09970) → study pick + AI-social-eng nucleus); **huntr degraded 2nd pass** (heal-flag); capture-leak clean (111 ids / 0 leaks).
...
[TRENDS.md](TRENDS.md) · [watchlist (26)](TRENDS.md#observation_queue) · [reports/](reports/) · [latest daily: 2026-07-14](reports/2026-07-14.md) · [weekly: 2026-W28](reports/weekly/2026-W28.md) · [AGENTS.md](AGENTS.md) · [SOURCES.md](SOURCES.md)
